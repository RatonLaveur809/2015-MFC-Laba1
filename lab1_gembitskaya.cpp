...
// lab1_gembitskaya.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект Clab1_gembitskayaApp

Clab1_gembitskayaApp theApp;


// инициализация Clab1_gembitskayaApp
...
// обработчики сообщений Clab1_gembitskayaApp
...
// Clab1_gembitskayaApp настройка методов загрузки и сохранения
